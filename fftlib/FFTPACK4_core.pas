...
const
  taur: TReal =-0.5;
  taui: TReal = 0.866025403784439;
var
  i,k,ac,ah: Int32;
  ci2,ci3,di2,di3,cr2,cr3: TReal;
  dr2,dr3: TReal;
  ti2,tr2: TReal;
begin
  if ido=2 then
...
var
  ...
  ci2,ci3,ci4,cr2,cr3,cr4: TReal;
  ti1,ti2,ti3,ti4,tr1,tr2,tr3,tr4: TReal;
...
const
  tr11: TReal = 0.309016994374947;
  ti11: TReal = 0.951056516295154;
  tr12: TReal =-0.809016994374947;
  ti12: TReal = 0.587785252292473;
var
  i,k,ac,ah,ido2,ido3,ido4,idl,idl2,idl3,idl4: Int32;
  ci2,ci3,ci4,ci5: TReal;
  di2,di3,di4,di5: TReal;
  cr2,cr3,cr5,cr4: TReal;
  ti2,ti3,ti4,ti5: TReal;
  dr2,dr3,dr4,dr5: TReal;
  tr2,tr3,tr4,tr5: TReal;
begin
  idl := l1*ido;
...
var
  i,k,ic: Int32;
  ci2,di2,di3,cr2,dr2,dr3,ti2,ti3,tr2,tr3: TReal;
begin      
  for k:=0 to l1-1 do
  begin
...
var
  i,k,ic: Int32;
  ci2,ci3,di2,di3,cr2,cr3,dr2,dr3,ti2,tr2: TReal;
begin      
  for k:=0 to l1-1 do
  begin
...
const
  hsqt2: TReal = 0.7071067811865475;
var
  i,k,ic: Int32;
  ci2,ci3,ci4: TReal;
  cr2,cr3,cr4: TReal;
  ti1,ti2,ti3,ti4: TReal;
  tr1,tr2,tr3,tr4: TReal;
begin
  for k:=0 to l1-1 do
  begin
...
var
  ...
  dc2,ds2,dcp,arg,dsp,ar1h,ar2h: TReal;
  ar1,ai1,ar2,ai2: TReal;
begin
  arg := TWOPI / ip;
  dcp := Cos(arg);
  dsp := Sin(arg);
...
var
  ...
  dc2,ds2,nbd,dcp,arg,dsp,ar1h,ar2h: TReal;
  ai1,ai2,ar1,ar2: TReal;
begin          
  arg := TWOPI / ip;
  dcp := Cos(arg);
  dsp := Sin(arg);
