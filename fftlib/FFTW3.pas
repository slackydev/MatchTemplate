...
type
  ...
  TFFTW = record
    ...
    function FFT2_R2C(m: T2DRealArray): T2DComplexArray;
    function FFT2_C2R(m: T2DComplexArray): T2DRealArray;
  end;
...
begin
  ...
  begin
    ...
    WriteLn('Failed to load FFTW3.3');
...
function TFFTW.FFT2_R2C(m: T2DRealArray): T2DComplexArray;
var
  y,w,h,newW: Int32;
  input: PReal;
  output: PComplex;
...
function TFFTW.FFT2_C2R(m: T2DComplexArray): T2DRealArray;
var
  x,y,w,h,newW: Int32;
  input: PComplex;
  output: PReal;
